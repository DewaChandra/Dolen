...
const tourismData = [
  {
    id: '1',
    name: 'Pecel Kawi Malang Hj. Musilah',
    location: 'Kota Malang, Jawa Timur',
    image: require('../../../assets/images/pecelkawi.jpg'),
  },
];

const PariwisataKuliner = ({ navigation }) => {
  const renderItem = ({ item }) => (
    <TouchableOpacity
      style={styles.touchableItem}
      onPress={() => {
        if (item.id === '1') {
          navigation.navigate('PecelKawi');
        } 
      }}>
...
export default PariwisataKuliner;